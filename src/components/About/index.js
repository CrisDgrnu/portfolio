            ...
            <div className="container about-page">
                <div className="text-zone">
                    ...
                    <p>
                        ...
                        learn new things, if you have arrived here looking
                        for a professional and passionate developer, you
                        have came to the right place!
                    </p>

                    <p>
                        My long term goal is to keep improving my skills to
                        be able to solve whatever challenge I meet. Also I
                        would love to work in a company where the people is
                        something more than a number.
                    </p>

                    <p>
                        Talking about my daily routine, during the day I'm
                        a Java developer, but during the night I always try
                        to spend some time making my own projects to learn
                        new technolohgies and skills. At the moment I'm so
